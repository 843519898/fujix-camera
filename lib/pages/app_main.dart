...
class _AppMainState extends State<AppMain>
  ...
  List<Map<String, dynamic>> get appBottomBar => [
    {
      'title': '首页',
      'activeIcon': 'asset/images/tabs/home_active.png',
      'inactiveIcon': 'asset/images/tabs/home.png',
      'body': Home(key: homeKey),
      'icon': Icons.home,
    },
    {
      'title': '素材',
      'activeIcon': 'asset/images/tabs/material_active.png',
      'inactiveIcon': 'asset/images/tabs/material.png',
      'body': const Placeholder(),
      'icon': Icons.home,
    },
    {
      'title': '工具',
      'activeIcon': 'asset/images/tabs/tools_active.png',
      'inactiveIcon': 'asset/images/tabs/tools.png',
      'body': const Placeholder(),
      'icon': Icons.home,
    },
    {
      'title': '收益',
      'activeIcon': 'asset/images/tabs/income_active.png',
      'inactiveIcon': 'asset/images/tabs/income.png',
      'body': const Placeholder(),
      'icon': Icons.home,
    },
    {
      'title': '我的',
      'activeIcon': 'asset/images/tabs/profile_active.png',
      'inactiveIcon': 'asset/images/tabs/profile.png',
      'body': const Placeholder(),
      'icon': Icons.home,
    },
  ];
  ...
  Widget _scaffoldBody() {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        elevation: 5.0,
        selectedFontSize: 14.sp, // 选中的字体大小
        unselectedFontSize: 14.sp, // 未选中的字体大小
        onTap: (int idx) async {
          setState(() {
            currentIndex = idx;
          });
    ...
    try {
      return appBottomBar.asMap().entries.map<BottomNavigationBarItem>((entry) {
        ...
        return BottomNavigationBarItem(
          icon: Image.asset(
            itemData['inactiveIcon'] as String,
            width: 22.sp,
            height: 22.sp,
          ),
          activeIcon: Image.asset(
            itemData['activeIcon'] as String,
            width: 22.sp,
            height: 22.sp,
          ),
